...
exports.localHourlySetPrice = void 0;
        ...
        currencies_1.Currencies.find()
            ...
            if (curs) {
                ...
                if (rialObj_1) {
                    ...
                    console.log("the now hours is...>", nowHour_1);
                    //let nextHour = moment(nowHour).add(1, 'hours')
                    localHourly_1.LocalHourly.findOne().sort({ name: -1 }).limit(1)
                        ...
                        if (lastDoc) {
                            ...
                            console.log("first last saved  hours is....", lastSavedHour);
                            console.log("second last saved  hours is....", lastSavedHour);
                            var lostedHours = moment.duration(nowHour_1.diff(lastSavedHour)).asHours();
                            console.log("losted hours is....", lostedHours);
                            var i = void 0;
                            var _loop_1 = function () {
                                ...
                                console.log("the start hour is...>", startHour);
                                console.log("the next hour hours is...>", nextHour);
                                acceptedOffers_1.Accepted_Offers.find({
                                    ...
                                    if (offers[0]) {
                                        ...
                                        localHourly_1.LocalHourly.create([doc]);
                                    }
                                    else {
